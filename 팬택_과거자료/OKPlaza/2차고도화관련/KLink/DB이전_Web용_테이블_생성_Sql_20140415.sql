...
ALTER TABLE TBL0002  ADD CONSTRAINT IX_TBL0002_PK PRIMARY KEY (KEDCD);
...
ALTER TABLE TBL0004  ADD CONSTRAINT IX_TBL0004_PK PRIMARY KEY (KEDCD, PCD);
...
ALTER TABLE TBL0011  ADD CONSTRAINT IX_TBL0011_PK PRIMARY KEY (KEDCD, STD_DT, RENP_SEQ);
...
ALTER TABLE TBL0013  ADD CONSTRAINT IX_TBL0013_PK PRIMARY KEY (KEDCD, STD_DT, STH_STT_SEQ);
...
ALTER TABLE TBL0014  ADD CONSTRAINT IX_TBL0014_PK PRIMARY KEY (KEDCD, BZPL_CD, BZPL_SEQ);
...
ALTER TABLE TBL0016  ADD CONSTRAINT IX_TBL0016_PK PRIMARY KEY (KEDCD, STD_DT, TTL_CD);
...
ALTER TABLE TBL0025  ADD CONSTRAINT IX_TBL0025_PK PRIMARY KEY (KEDCD, PSTD_SEQ);
...
ALTER TABLE TBL0026  ADD CONSTRAINT IX_TBL0026_PK PRIMARY KEY (KEDCD, STD_DT, TXPL_CCD, TXPL_SEQ);
...
ALTER TABLE TBL0041  ADD CONSTRAINT IX_TBL0041_PK PRIMARY KEY (KEDCD, REG_DT);
...
ALTER TABLE TBL0050  ADD CONSTRAINT IX_TBL0050_PK PRIMARY KEY (KEDCD, STTL_BASE_YM_DD, FS_INFO_CD, ACCT_CCD, ACC_CD_FULL);
