...
-- 안전몰 코드 수정
--select * from smpcodes where codetypecd = 'SVCTYPECD' and agent_id = '13' and codeval1 = 'SAF';
update smpcodes set isuse = 0 where codetypecd = 'SVCTYPECD' and agent_id = '13' and codeval1 = 'SAF';
...
INNER JOIN SMPUSERS C
		...
		AND C.ISUSE = 1
LEFT OUTER JOIN SMPDIRECTINFO D
	ON A.BORGID = D.BRANCHID
	AND	A.USERID = D.USERID
	AND	B.USERID = D.DIRECTORID
WHERE A.USE_YN = 'Y'
AND D.BRANCHID IS NULL
;

-- 지점장 권한 사용자 일반권한으로 인서트 - 지점장 권한 다시 활성화 해서 추가 안함
/*
...
--select * from smproles where rolecd like '%HNS%';
------------------------------------------------------------------------------
...
INSERT INTO SMP_TEMPLATE_MNG (TEMPLATE_CD,SEND_TYPE,SEND_SVC,TITLE,CONTENTS,DESCRIPTION,INSERT_USER_ID,INSERT_DATE,UPDATE_USER_ID,UPDATE_DATE) VALUES (N'OKPlaza029',N'KKO',N'OKP',N'여신초과 주문 시',N'[#{svcName}] 주문번호 [#{ordeIdenNumb}] #{ordeType} 주문처리 요청이 왔습니다.',N'운영사 코드관리(BONDS_MANAGER)에 회계담당자로 지정된 사용자',NULL,NULL,NULL,NULL);
...
INSERT INTO SMP_TEMPLATE_MNG (TEMPLATE_CD,SEND_TYPE,SEND_SVC,TITLE,CONTENTS,DESCRIPTION,INSERT_USER_ID,INSERT_DATE,UPDATE_USER_ID,UPDATE_DATE) VALUES (N'OKPlaza045',N'KKO',N'OKP',N'구매사 상품 주문시',N'[#{svcName}] 자재 재고관리 대상 주문 건이 있습니다. 
주문번호: [#{ordeIdenNumb}-#{ordeSequNumb}] 
구매사 : [#{borgNm}] 
상품명: [#{goodName}] 
규격: [#{goodSpec}] 
주문자성명: [#{ordeUserName}] 
주문자연락처: [#{ordeTeleNumb}]',N'운영사 상품담당자',NULL,NULL,NULL,NULL);
...
INSERT INTO SMP_TEMPLATE_MNG (TEMPLATE_CD,SEND_TYPE,SEND_SVC,TITLE,CONTENTS,DESCRIPTION,INSERT_USER_ID,INSERT_DATE,UPDATE_USER_ID,UPDATE_DATE) VALUES (N'OKPlaza050',N'KKO',N'OKP',N'홈앤서비스 재고조사 등록 or 수정 시',N'#{svcName}] 재고조사 승인 요청 건이 있습니다. 

"HOMS>재고/예산>재고조사"화면에서 확인해 주시길 바랍니다.',N'(As-Is)사업장의 지점장 권한을 가진 사용자에게 발송 => (To-Be) 사업장의 감독관에게 발송',NULL,NULL,NULL,NULL);
INSERT INTO SMP_TEMPLATE_MNG (TEMPLATE_CD,SEND_TYPE,SEND_SVC,TITLE,CONTENTS,DESCRIPTION,INSERT_USER_ID,INSERT_DATE,UPDATE_USER_ID,UPDATE_DATE) VALUES (N'OKPlaza050-001',N'KKO',N'OKP',N'홈앤서비스 재고조사 등록 or 수정 시 (OKPlaza050-001)',N'[#{svcName}] 재고조사 승인 요청 건이 있습니다.
자세한 내용은 HOMS>재고/예산>재고조사 에서 확인해 주시길 바랍니다.',N'(As-Is)사업장의 지점장 권한을 가진 사용자에게 발송 => (To-Be) 사업장의 감독관에게 발송',NULL,NULL,NULL,NULL);
...
INSERT INTO SMP_TEMPLATE_MNG (TEMPLATE_CD,SEND_TYPE,SEND_SVC,TITLE,CONTENTS,DESCRIPTION,INSERT_USER_ID,INSERT_DATE,UPDATE_USER_ID,UPDATE_DATE) VALUES (N'OKPlaza055',N'SMS',N'OKP',N'잠금 상태 해제',N'[#{svcName}] 사용 계정의 잠금 해제가 완료되었습니다. 새로운 비밀번호는 [#{randPassword}] 입니다',N'잠김해제 사용자',NULL,NULL,NULL,NULL);
...
INSERT INTO SMP_TEMPLATE_MNG (TEMPLATE_CD,SEND_TYPE,SEND_SVC,TITLE,CONTENTS,DESCRIPTION,INSERT_USER_ID,INSERT_DATE,UPDATE_USER_ID,UPDATE_DATE) VALUES (N'OKPlaza056-001',N'KKO',N'OKP',N'신규상품등록 반려 (OKPlaza056-001)',N'[#{svcName}] 신규 등록 요청하신 상품이 반려 처리 되었습니다. 
자세한 내용은 상품관리>신규상품요청현황 에서 확인해 주시길 바랍니다.',N'신규상품 등록자',NULL,NULL,NULL,NULL);
...
INSERT INTO SMP_TEMPLATE_MNG (TEMPLATE_CD,SEND_TYPE,SEND_SVC,TITLE,CONTENTS,DESCRIPTION,INSERT_USER_ID,INSERT_DATE,UPDATE_USER_ID,UPDATE_DATE) VALUES (N'OKPlaza058',N'KKO',N'OKP',N'고객사상품등록요청 기상품 처리',N'[#{svcName}] #{userNm}님 
신규 등록 요청하신 상품이 등록 처리 되었습니다. 

자세한 내용은 상품관리>신규상품요청 에서 확인해 주시길 바랍니다.',N'신규상품 등록자',NULL,NULL,NULL,NULL);
...
INSERT INTO SMP_TEMPLATE_MNG (TEMPLATE_CD,SEND_TYPE,SEND_SVC,TITLE,CONTENTS,DESCRIPTION,INSERT_USER_ID,INSERT_DATE,UPDATE_USER_ID,UPDATE_DATE) VALUES (N'OKPlaza072',N'KKO',N'OKP',N'선입금시 주문자에게 SMS 발송',N'[#{svcName}] 주문하신 건(주문번호 #{orderNum}) 에 대한 #{prepayPriceString}원을 선입금하여 주시길 바랍니다.',N'주문자',NULL,NULL,NULL,NULL);
...
INSERT INTO SMP_TEMPLATE_MNG (TEMPLATE_CD,SEND_TYPE,SEND_SVC,TITLE,CONTENTS,DESCRIPTION,INSERT_USER_ID,INSERT_DATE,UPDATE_USER_ID,UPDATE_DATE) VALUES (N'OKPlaza082',N'KKO',N'OKP',N'주문접수 시',N'[#{svcName}] [#{vendorNm}]에서 [#{ordeIdenNumb2}], [#{goodName}]에 대하여 #{deliDate}에 납품 예정입니다. * #{vendorNm} 배송 문의 : #{vendorPhone}',N'주문자',NULL,NULL,NULL,NULL);
...
INSERT INTO SMP_TEMPLATE_MNG (TEMPLATE_CD,SEND_TYPE,SEND_SVC,TITLE,CONTENTS,DESCRIPTION,INSERT_USER_ID,INSERT_DATE,UPDATE_USER_ID,UPDATE_DATE) VALUES (N'OKPlaza097-001',N'KKO',N'WMS',N'물류인 경우 주문자, 인수자 발송 (OKPlaza097-001)',N'통합물류센터에서 [#{orde_iden_numb}-#{orde_sequ_numb}], [#{good_name}]을(를) 출하하였습니다. 
* 배송 문의 : #{admWorkInfo}',N'주문자',NULL,NULL,NULL,NULL);
...
INSERT INTO SMP_TEMPLATE_MNG (TEMPLATE_CD,SEND_TYPE,SEND_SVC,TITLE,CONTENTS,DESCRIPTION,INSERT_USER_ID,INSERT_DATE,UPDATE_USER_ID,UPDATE_DATE) VALUES (N'OKPlaza103',N'KKO',N'OKP',N'팬타온 판매자 약관 동의 요청',N'[OK plaza] 팬타온 판매자 등록을 요청드립니다.
- OK플라자 접속 후 메인페이지에서 팬타온 판매자 약관 팝업을 확인하시거나,
- “최상단 법인명 클릭 > 공급사 상세 팝업 >팬타온 판매자 약관 동의 / 철회 > 약관보기” 에서 약관 확인 및 동의를 진행해 주시기 바랍니다.',N'공급사 영업담당자',NULL,NULL,NULL,NULL);
INSERT INTO SMP_TEMPLATE_MNG (TEMPLATE_CD,SEND_TYPE,SEND_SVC,TITLE,CONTENTS,DESCRIPTION,INSERT_USER_ID,INSERT_DATE,UPDATE_USER_ID,UPDATE_DATE) VALUES (N'OKPlaza104',N'KKO',N'OKP',N'팬타온 상품진열',N'[OK plaza] #{vendorNm} 님. OK plaza에 등록하신 상품이 팬타온에 진열되었습니다.
 - 상품코드 : #{GOOD_IDEN_NUMB}
 - 상품명 : #{GOOD_NAME}
 자세한 내용은 OK플라자 홈페이지 > 상품 > 상품관리 > 상품상세 에서 확인해 주세요.',N'공급사 영업담당자',NULL,NULL,NULL,NULL);
...
INSERT INTO SMP_TEMPLATE_MNG (TEMPLATE_CD,SEND_TYPE,SEND_SVC,TITLE,CONTENTS,DESCRIPTION,INSERT_USER_ID,INSERT_DATE,UPDATE_USER_ID,UPDATE_DATE) VALUES (N'OKPlaza111',N'SMS',N'PTO',N'펜타온 사용자등록',N'[#{svcName}] 펜타온 사용자등록이 완료되었습니다. 로그인ID: #{loginId} 암호: #{randPassword}',N'운영사 에서 사용자등록 시 사용자에게 로그인ID와 함호를 전달',NULL,NULL,NULL,NULL);
...
-- 그 외 추가인덱스들
CREATE NONCLUSTERED INDEX IDX_MCGOOD_003 ON mcgood (  insert_date ASC  )  ;
CREATE NONCLUSTERED INDEX IDX_MCGOODAPP_001 ON MCGOODAPP (  GOOD_APP_NUMB ASC  , GOOD_IDEN_NUMB ASC  , VENDORID ASC  )  ;
CREATE NONCLUSTERED INDEX IDX_LOGIINFO_003 ON LOGI_INFO (  GOOD_IDEN_NUMB ASC  , VENDORID ASC  , ENTER_STATE ASC  );
CREATE NONCLUSTERED INDEX IDX_MCGOOD_HNS_APP_02 ON MCGOOD_HNS_APP (  REQ_DATE ASC  );
CREATE NONCLUSTERED INDEX IDX_MRORDM_005 ON mrordm (  orde_user_id ASC  );
...
UPDATE SMPWORKINFO SET SITE_ID = 1 WHERE SITE_ID IS NULL;	-- okplaza 기본(전체)
UPDATE SMPWORKINFO SET SITE_ID = 2, CUST_CATE_MAST_CD = 'HNS' WHERE workid in ('57', '60', '70', '73'); -- 홈앤서비스
UPDATE SMPWORKINFO SET SITE_ID = 3, CUST_CATE_MAST_CD = 'SAF' WHERE workid = '63'; -- OKSafety
--UPDATE SMPWORKINFO SET SITE_ID = 1 WHERE WORKNM LIKE '%HNS%';  
-- SITE_ID 디폴트 1(OKPLAZA 기본);

select * from MCGOODDISPLAY where DISPLAY_TYPE = '20' and  DISPLAY_TYPE_CD = 0 and insert_date < '2017-01-01';
-- 이젠 안쓰는 전체 유형의 공사유형 값 삭제
delete from MCGOODDISPLAY where DISPLAY_TYPE = '20' and  DISPLAY_TYPE_CD = 0 and insert_date < '2017-01-01';
...
ORDER BY A.MATERIAL, A.VENDORID;
----------------------------------------------------------------------------------
--drop table MCGOOD_MATERIAL_DETL
CREATE TABLE MCGOOD_MATERIAL_DETL (
    MATERIAL_DETL_CD varchar(30) NOT NULL,	-- 세부품종코드
    MATERIAL varchar(30) NOT NULL,			-- 지정품종코드
    MATERIAL_DETL_NM varchar(100) NOT NULL,	-- 세부품종명
    MATERIAL_DETL_DESC varchar(200) NULL,	-- 세부품종내역
...
-- HOMS 구마사 카테고리 추가 - 홈스는 1단계만 존재
INSERT mccust_cate_new
(
	CUST_CATE_CD
,	CUST_CATE_MAST_CD
,	PAR_CUST_CATE_CD
...
SELECT 
	'HNS' + RIGHT('00' + CAST(ROW_NUMBER() OVER (ORDER BY CATE_SORT) AS VARCHAR), 2) AS CUST_CATE_CD
,	'HNS' AS CUST_CATE_MAST_CD
,	'HNS' AS PAR_CUST_CATE_CD
,	CUST_CATE_NM AS CUST_CATE_NM
,	0 AS CATE_LEVEL
,	'Y' AS USE_YN
,	'N' AS PANTA_BEST_YN
,	CATE_SORT AS [ORDERING]
,	CUST_CATE_CD AS CUST_CATE_DESC
,	'2' AS INSERT_USER_ID
,	GETDATE() AS INSERT_DATE
,	'2' AS UPDATE_USER_ID
,	GETDATE() AS UPDATE_DATE
...
,		GETDATE() AS INSERT_DATE
FROM mccust_cate_new A
INNER JOIN MCCUST_CATE_LINE B
	ON A.CUST_CATE_DESC = B.CUST_CATE_CD 
LEFT OUTER JOIN MCCATEGORYMASTER C
	ON B.CATE_ID = C.cate_id
WHERE A.CUST_CATE_MAST_CD = 'HNS'
AND C.cate_id IS NOT NULL
ORDER BY A.[ORDERING]
;


-- OKSafety 카테고리 기본 - 2단계까지 존재
INSERT INTO MCCUST_CATE_NEW (
	CUST_CATE_CD
,	CUST_CATE_MAST_CD
,	PAR_CUST_CATE_CD
...
SELECT  
    'SAF' + RIGHT('00' + CAST(ROW_NUMBER() OVER (ORDER BY M.ORD_NUM) AS VARCHAR), 2) AS CUST_CATE_CD,
    'SAF' AS CUST_CATE_MAST_CD,
    'SAF' AS PAR_CUST_CATE_CD,
    M.majo_code_name AS CUST_CATE_NM,
    M.CATE_LEVEL - 2 AS CATE_LEVEL,
    'Y' AS USE_YN,
    M.ORD_NUM AS ORDERING,
    'N' AS PANTA_BEST_YN,
    CATE_ID AS CUST_CATE_DESC,
...
INNER JOIN MCCUST_CATE_NEW B
	ON A.ref_cate_seq = B.CUST_CATE_DESC
	AND B.CUST_CATE_MAST_CD = 'SAF'
WHERE A.AGENT_ID = '13'
AND A.cate_level = 3
AND A.CATE_CD LIKE 'H%'
ORDER BY B.CUST_CATE_CD,CONVERT(INT, A.ORD_NUM);


-- OKSafety 카테고리 - 표준카테고리 연결
INSERT MCCUST_CATE_NEW_CONN
SELECT	A.CUST_CATE_CD
,		B.cate_id
,		'2' AS INSERT_USER_ID 
...
--INSERT INTO SMP_SEQUENCE ( TABLE_NAME,   NEXT_ID ) VALUES ('SEQ_MRCOMP_INFO',   (select max(COMP_ID) +1 from MRCOMP_INFO));
update SMP_SEQUENCE set NEXT_ID = (select max(COMP_ID) +1 from MRCOMP_INFO) where TABLE_NAME = 'SEQ_MRCOMP_INFO';
select * from SMP_SEQUENCE where TABLE_NAME = 'SEQ_MRCOMP_INFO';
...
values (13, getdate() ,'', '', '', '', '', '', '', '', '2', getdate())

-- 팬타온 물류는 무료배송 Y 라서
UPDATE SMPVENDORS_PANTA SET FREE_DELI_YN = 'Y' WHERE vendorid = '13';
---------------------------------------------------------------------------------------------
-- 팬타온 배송 기준표
...
-- 매출헤더 -  팬타온 매출아이디 -3 추가
INSERT INTO MSSALM (sale_sequ_numb,clientid,branchid,sale_sequ_name,crea_sale_userid,crea_sale_date,sale_conf_userid,sale_conf_date,clos_sale_date,sale_requ_amou,sale_requ_vtax,sale_tota_amou,sap_jour_numb,expiration_date,tran_sap_jour_date,tran_user_id,pay_amou_numb,pay_amou,tran_stat_flag,paym_cond_code,sale_over_month,sale_over_day,sale_pay_date,create_borgid,transfer_status,transfer_date,sale_invoice_chk,sale_invoice_userid,sale_invoice_date,vtax_clas_code,AGENT_ID,TEMP_CLOS_SALE_DATE,TEMP_USERID,TEMP_SAVE_DATE,purc_requ_amou,ERP_APPLY_YN,SELLING_YN,CDACCT) VALUES
    (N'-3',N'0',N'0',NULL,NULL,NULL,NULL,'1900-01-01 00:00:00.0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'13',N'1',NULL,NULL,NULL,NULL,N'10',N'13',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
,	VENDOR_STOCK_YN CHAR(1) default 'Y'
...
select count(1), VENDOR_STOCK_YN from mcgoodvendor group by mcgoodvendor.VENDOR_STOCK_YN;

update mcgoodvendor set VENDOR_STOCK_YN = 'Y' where VENDOR_STOCK_YN is null;
-- 해당 테이블 디폴트 값 업데이트 Y 로
...
-- 구매사 카테고리 기준
/* common.schedule.insertDailyBatRecent3OrdeMcCustCate - 구매사 카테고리 기준 최근 3개월 주문 집게 */
...
-- 구매사 카테고리 없는 기준 >> 표준카테고리로 집계하는 부분이 사라져서 주석처리
/* common.schedule.insertDailyBatRecent3OrdeMcCate - 표준카테고리 기준 최근 3개월 집계 */
/*WITH CategoryHierarchy AS (
    SELECT 
        cate_id, 
        majo_code_name, 
...
/* common.schedule.insertDailyBatRecent3OrdeMcCateForHns - 홈앤서비스 기준 최근 3개월 주문 집게 */
WITH CategoryHierarchy AS (
    SELECT 
        CUST_CATE_CD, 
        CUST_CATE_NM, 
        PAR_CUST_CATE_CD, 
        cate_level,
        CUST_CATE_CD AS PAR_CATE_ID
    FROM MCCUST_CATE_NEW
    WHERE cate_level = 0 -- HNS 기준
    AND CUST_CATE_CD LIKE 'HNS%'
    UNION ALL
    SELECT 
        m.CUST_CATE_CD, 
        m.CUST_CATE_NM, 
...
,	VENDORID VARCHAR(20) NOT NULL
,	REFUND_NUM int DEFAULT 0 
,	PAY_YN VARCHAR(1) DEFAULT 'N'
,	DELIVERY_AMOUNT DECIMAL(15,0) DEFAULT 0 NOT NULL
,	BUYI_SEQU_NUMB VARCHAR(10) NOT NULL
,	PRIMARY KEY (ORDE_IDEN_NUMB, VENDORID, REFUND_NUM)
);
EXEC OKPlaza.sys.sp_addextendedproperty 'MS_Description', N'환불차수', 'schema', N'dbo', 'table', N'MRDELIVERY_AMOUNT', 'column', N'REFUND_NUM';
EXEC OKPlaza.sys.sp_addextendedproperty 'MS_Description', N'매입ID', 'schema', N'dbo', 'table', N'MRDELIVERY_AMOUNT', 'column', N'BUYI_SEQU_NUMB';
--DROP TABLE MRDELIVERY_AMOUNT;
   
/*ALTER TABLE OKPlaza.dbo.MRDELIVERY_AMOUNT ADD REFUND_NUM int DEFAULT 0;
EXEC OKPlaza.sys.sp_addextendedproperty 'MS_Description', N'환불차수', 'schema', N'dbo', 'table', N'MRDELIVERY_AMOUNT', 'column', N'REFUND_NUM';

UPDATE MRDELIVERY_AMOUNT
SET REFUND_NUM = 0

ALTER TABLE OKPlaza.dbo.MRDELIVERY_AMOUNT ADD  DEFAULT 0 FOR REFUND_NUM;
ALTER TABLE OKPlaza.dbo.MRDELIVERY_AMOUNT ALTER COLUMN REFUND_NUM int NOT NULL;

ALTER TABLE OKPlaza.dbo.MRDELIVERY_AMOUNT DROP CONSTRAINT PK__MRDELIVE__FCDBA2EF891173E0;
ALTER TABLE OKPlaza.dbo.MRDELIVERY_AMOUNT ADD CONSTRAINT MRDELIVERY_AMOUNT_PK PRIMARY KEY (ORDE_IDEN_NUMB,VENDORID,REFUND_NUM);*/
...
-- 기존 코드 추가건
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BOARD_BORG_TYPE' AND AGENT_ID = '13'),N'BOARD_BORG_TYPE',N'PTO',N'',N'',N'팬타온',N'',N'',6,1,N'13','2',getdate(),'2',getdate());
...
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FAQ_TYPE' AND AGENT_ID = '13'),N'FAQ_TYPE',N'1002',N'FAQ_PTO',N'',N'상품',N'',N'',1002,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FAQ_TYPE' AND AGENT_ID = '13'),N'FAQ_TYPE',N'1003',N'FAQ_PTO',N'',N'주문',N'',N'',1003,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FAQ_TYPE' AND AGENT_ID = '13'),N'FAQ_TYPE',N'1004',N'FAQ_PTO',N'',N'결제',N'',N'',1004,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FAQ_TYPE' AND AGENT_ID = '13'),N'FAQ_TYPE',N'1005',N'FAQ_PTO',N'',N'배송',N'',N'',1005,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FAQ_TYPE' AND AGENT_ID = '13'),N'FAQ_TYPE',N'1006',N'FAQ_PTO',N'',N'취소/반품/교환',N'',N'',1006,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FAQ_TYPE' AND AGENT_ID = '13'),N'FAQ_TYPE',N'1009',N'FAQ_PTO',N'',N'기타',N'',N'',1009,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'RETURNSTATUSFLAG' AND AGENT_ID = '13'),N'RETURNSTATUSFLAG',N'2',N'',N'',N'환불완료',N'',N'',2,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'ORDERCHANGEMESSAGE' AND AGENT_ID = '13'),N'ORDERCHANGEMESSAGE',N'301',N'',N'',N'[교환] 철회 처리.',N'',N'',301,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'ORDERCHANGEMESSAGE' AND AGENT_ID = '13'),N'ORDERCHANGEMESSAGE',N'302',N'',N'',N'[교환] 요청.',N'',N'',302,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'ORDERCHANGEMESSAGE' AND AGENT_ID = '13'),N'ORDERCHANGEMESSAGE',N'303',N'',N'',N'[교환] 완료 처리.',N'',N'',303,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'ORDERCHANGEMESSAGE' AND AGENT_ID = '13'),N'ORDERCHANGEMESSAGE',N'304',N'',N'',N'[환불] 완료 처리.',N'',N'',304,1,N'13','2',getdate(),'2',getdate());
...
-- 추가코드 인서트
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BID_RESULT' AND AGENT_ID = '13'),N'BID_RESULT',N'10',N'',N'',N'선정중',N'',N'',1,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BID_RESULT' AND AGENT_ID = '13'),N'BID_RESULT',N'15',N'',N'',N'자율',N'',N'',2,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BID_RESULT' AND AGENT_ID = '13'),N'BID_RESULT',N'1',N'',N'',N'1순위',N'',N'',3,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BID_RESULT' AND AGENT_ID = '13'),N'BID_RESULT',N'2',N'',N'',N'2순위',N'',N'',4,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BID_RESULT' AND AGENT_ID = '13'),N'BID_RESULT',N'3',N'',N'',N'3순위',N'',N'',5,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BID_RESULT' AND AGENT_ID = '13'),N'BID_RESULT',N'4',N'',N'',N'4순위',N'',N'',6,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BID_RESULT' AND AGENT_ID = '13'),N'BID_RESULT',N'5',N'',N'',N'5순위',N'',N'',7,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BID_RESULT' AND AGENT_ID = '13'),N'BID_RESULT',N'6',N'',N'',N'6순위',N'',N'',8,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BID_RESULT' AND AGENT_ID = '13'),N'BID_RESULT',N'7',N'',N'',N'7순위',N'',N'',9,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BID_RESULT' AND AGENT_ID = '13'),N'BID_RESULT',N'9',N'',N'',N'미수용',N'',N'',10,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BID_RESULT' AND AGENT_ID = '13'),N'BID_RESULT',N'0',N'',N'',N'-',N'',N'',11,1,N'13','2',getdate(),'2',getdate());


INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_MANAGE' AND AGENT_ID = '13'),N'MATERIAL_MANAGE',N'10',N'',N'',N'SKT 전용 (무선)',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_MANAGE' AND AGENT_ID = '13'),N'MATERIAL_MANAGE',N'20',N'',N'',N'SKT 전용 (유선)',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_MANAGE' AND AGENT_ID = '13'),N'MATERIAL_MANAGE',N'30',N'',N'',N'T/B 공용',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_MANAGE' AND AGENT_ID = '13'),N'MATERIAL_MANAGE',N'40',N'',N'',N'SKB 전용',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_USED' AND AGENT_ID = '13'),N'MATERIAL_USED',N'10',N'',N'',N'전기',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_USED' AND AGENT_ID = '13'),N'MATERIAL_USED',N'11',N'',N'',N'A망',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_USED' AND AGENT_ID = '13'),N'MATERIAL_USED',N'12',N'',N'',N'전송망',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_USED' AND AGENT_ID = '13'),N'MATERIAL_USED',N'13',N'',N'',N'구축',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_USED' AND AGENT_ID = '13'),N'MATERIAL_USED',N'14',N'',N'',N'선로',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_USED' AND AGENT_ID = '13'),N'MATERIAL_USED',N'15',N'',N'',N'FTTH',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_USED' AND AGENT_ID = '13'),N'MATERIAL_USED',N'16',N'',N'',N'광랜',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_USED' AND AGENT_ID = '13'),N'MATERIAL_USED',N'17',N'',N'',N'HFC',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_USED' AND AGENT_ID = '13'),N'MATERIAL_USED',N'18',N'',N'',N'개통',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_USED' AND AGENT_ID = '13'),N'MATERIAL_USED',N'19',N'',N'',N'CATV',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_USED' AND AGENT_ID = '13'),N'MATERIAL_USED',N'20',N'',N'',N'관로',N'',N'',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'MATERIAL_USED' AND AGENT_ID = '13'),N'MATERIAL_USED',N'21',N'',N'',N'HNS',N'',N'',0,1,N'13','2',getdate(),'2',getdate());


INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'3K',N'IBK_BC',N'',N'기업 BC',N'기업비씨',N'',1,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'46',N'GWANGJUBANK',N'',N'광주은행',N'광주',N'',2,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'71',N'LOTTE',N'',N'롯데카드',N'롯데',N'',3,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'30',N'KDBBANK',N'',N'KDB산업은행',N'산업',N'',4,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'31',N'BC',N'',N'BC카드',N'',N'',5,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'51',N'SAMSUNG',N'',N'삼성카드',N'삼성',N'',6,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'38',N'SAEMAUL',N'',N'새마을금고',N'새마을',N'',7,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'41',N'SHINHAN',N'',N'신한카드',N'신한',N'',8,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'62',N'SHINHYEOP',N'',N'신협',N'신협',N'',9,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'36',N'CITI',N'',N'씨티카드',N'씨티',N'',10,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'33',N'WOORI',N'',N'우리BC카드(BC 매입)',N'우리',N'',11,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'W1',N'WOORI',N'',N'우리카드(우리 매입)',N'우리',N'',12,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'37',N'POST',N'',N'우체국예금보험',N'우체국',N'',13,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'39',N'SAVINGBANK',N'',N'저축은행중앙회',N'저축',N'',15,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'35',N'JEONBUKBANK',N'',N'전북은행',N'전북',N'',16,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'42',N'JEJUBANK',N'',N'제주은행',N'제주',N'',17,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'15',N'KAKAOBANK',N'',N'카카오뱅크',N'카카오뱅크',N'',18,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'3A',N'KBANK',N'',N'케이뱅크',N'케이뱅크',N'',19,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'24',N'TOSSBANK',N'',N'토스뱅크',N'토스뱅크',N'',20,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'21',N'HANA',N'',N'하나카드',N'하나',N'',21,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'61',N'HYUNDAI',N'',N'현대카드',N'현대',N'',22,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'11',N'KOOKMIN',N'',N'KB국민카드',N'국민',N'',23,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'91',N'NONGHYEOP',N'',N'NH농협카드',N'농협',N'',24,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'CARD_ISSUER' AND AGENT_ID = '13'),N'CARD_ISSUER',N'34',N'SUHYEOP',N'',N'Sh수협은행',N'수협',N'',26,1,N'13','2',getdate(),'2',getdate());

INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BUY_SVC' AND AGENT_ID = '13'),N'BUY_SVC',N'OKP',N'',N'',N'OKPLAZA 기본',N'',N'',1,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BUY_SVC' AND AGENT_ID = '13'),N'BUY_SVC',N'HNS',N'',N'',N'홈앤서비스',N'',N'',2,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BUY_SVC' AND AGENT_ID = '13'),N'BUY_SVC',N'SAF',N'',N'',N'OKSAFETY',N'',N'',3,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'BUY_SVC' AND AGENT_ID = '13'),N'BUY_SVC',N'PTO',N'',N'',N'팬타온',N'',N'',4,1,N'13','2',getdate(),'2',getdate());


INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_end_cause' AND AGENT_ID = '13'),N'pto_end_cause',N'1',N'',N'',N'아이디변경/재가입목적',N'',N'',1,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_end_cause' AND AGENT_ID = '13'),N'pto_end_cause',N'2',N'',N'',N'회원가입의 실질적인 혜택이 없음',N'',N'',2,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_end_cause' AND AGENT_ID = '13'),N'pto_end_cause',N'3',N'',N'',N'광고성 메일, SMS가 많아짐',N'',N'',3,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_end_cause' AND AGENT_ID = '13'),N'pto_end_cause',N'4',N'',N'',N'배송 및 가격불만, 상품부족',N'',N'',4,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_end_cause' AND AGENT_ID = '13'),N'pto_end_cause',N'5',N'',N'',N'응대 불친절',N'',N'',5,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_end_cause' AND AGENT_ID = '13'),N'pto_end_cause',N'6',N'',N'',N'잦은 시스템 에러',N'',N'',6,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_end_cause' AND AGENT_ID = '13'),N'pto_end_cause',N'7',N'',N'',N'기타',N'',N'',7,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'PTO_REQU_STAT_FLAG' AND AGENT_ID = '13'),N'PTO_REQU_STAT_FLAG',N'10',N'',N'',N'회원',N'',N'',10,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'PTO_REQU_STAT_FLAG' AND AGENT_ID = '13'),N'PTO_REQU_STAT_FLAG',N'20',N'',N'',N'상품',N'',N'',20,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'PTO_REQU_STAT_FLAG' AND AGENT_ID = '13'),N'PTO_REQU_STAT_FLAG',N'30',N'',N'',N'주문',N'',N'',30,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'PTO_REQU_STAT_FLAG' AND AGENT_ID = '13'),N'PTO_REQU_STAT_FLAG',N'40',N'',N'',N'결제',N'',N'',40,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'PTO_REQU_STAT_FLAG' AND AGENT_ID = '13'),N'PTO_REQU_STAT_FLAG',N'50',N'',N'',N'배송',N'',N'',50,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'PTO_REQU_STAT_FLAG' AND AGENT_ID = '13'),N'PTO_REQU_STAT_FLAG',N'60',N'',N'',N'취소/반품/교환',N'',N'',60,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'PTO_REQU_STAT_FLAG' AND AGENT_ID = '13'),N'PTO_REQU_STAT_FLAG',N'90',N'',N'',N'기타',N'',N'',90,1,N'13','2',getdate(),'2',getdate());


-- 실 반영 시, url 수정
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FRONT_BG' AND AGENT_ID = '13'),N'FRONT_BG',N'전자입찰 시스템',N'/assets/images/banner_bid.png',N'https://devebid.okplaza.kr/',N'이미지명',N'Background 이미지 src',N'바로가기 링크',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FRONT_BG' AND AGENT_ID = '13'),N'FRONT_BG',N'팬타온 ICT 마켓',N'/assets/images/banner_panta.png',N'https://devpantaon.okplaza.kr/',N'이미지명',N'Background 이미지 src',N'바로가기 링크',0,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FRONT_BG' AND AGENT_ID = '13'),N'FRONT_BG',N'SK 통신자재 오픈소싱',N'/assets/images/banner_open.png',N'/suggest',N'이미지명',N'Background 이미지 src',N'바로가기 링크',0,1,N'13','2',getdate(),'2',getdate());
...
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FRONT_CSS_COLOR' AND AGENT_ID = '13'),N'FRONT_CSS_COLOR',N'기본',N'/assets/css/common_turquoise.css',N'',N'색상',N'CSS 경로',N'',1,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FRONT_CSS_COLOR' AND AGENT_ID = '13'),N'FRONT_CSS_COLOR',N'빨강',N'/assets/css/common.css',N'',N'색상',N'CSS 경로',N'',2,2,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FRONT_CSS_COLOR' AND AGENT_ID = '13'),N'FRONT_CSS_COLOR',N'검정',N'/assets/css/common_black.css    ',N'',N'색상',N'CSS 경로',N'',3,3,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FRONT_CSS_COLOR' AND AGENT_ID = '13'),N'FRONT_CSS_COLOR',N'파랑',N'/assets/css/common_blue.css',N'',N'색상',N'CSS 경로',N'',4,4,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FRONT_CSS_COLOR' AND AGENT_ID = '13'),N'FRONT_CSS_COLOR',N'초록',N'/assets/css/common_green.css',N'',N'색상',N'CSS 경로',N'',5,5,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FRONT_CSS_COLOR' AND AGENT_ID = '13'),N'FRONT_CSS_COLOR',N'주황',N'/assets/css/common_orange.css',N'',N'색상',N'CSS 경로',N'',6,6,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'FRONT_CSS_COLOR' AND AGENT_ID = '13'),N'FRONT_CSS_COLOR',N'보라',N'/assets/css/common_purple.css',N'',N'색상',N'CSS 경로',N'',7,7,N'13','2',getdate(),'2',getdate());


INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'10',N'1',N'',N'다른상품 재주문',N'',N'',10,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'20',N'1',N'',N'상품에 이상 없으나 구매 의사 없어짐',N'',N'',20,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'30',N'1',N'',N'상품이 상세정보와 다름',N'',N'',30,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'40',N'1',N'',N'배송지연',N'',N'',40,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'50',N'1',N'',N'기타',N'',N'',50,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'60',N'2',N'',N'상품에 이상 없으나 구매 의사 없어짐',N'',N'',60,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'70',N'2',N'',N'사이즈, 색상 등 규격을 잘못 선택함',N'',N'',70,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'80',N'2',N'',N'상품이 상세정보와 다름',N'',N'',80,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'90',N'2',N'',N'배송된 상품의 파손/하자/포장불량',N'',N'',90,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'100',N'2',N'',N'다른 상품으로 잘못 배송됨',N'',N'',100,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'110',N'2',N'',N'배송지연',N'',N'',110,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'111',N'2',N'',N'기타',N'',N'',111,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'120',N'3',N'',N'사이즈, 색상 등 규격을 잘못 선택',N'',N'',120,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'130',N'3',N'',N'상품이 상세정보와 다름',N'',N'',130,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'140',N'3',N'',N'배송된 상품의 파손/하자/포장불량',N'',N'',140,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'150',N'3',N'',N'다른 상품으로 잘못 배송됨',N'',N'',150,1,N'13','2',getdate(),'2',getdate());
INSERT INTO SMPCODES VALUES ((select max(IIF(a.CODEID > b.CODETYPEID , a.CODEID, b.CODETYPEID))+1 from SMPCODES a, SMPCODETYPES b),(SELECT CODETYPEID FROM SMPCODETYPES WHERE CODETYPECD = 'pto_ORDE_reason' AND AGENT_ID = '13'),N'pto_ORDE_reason',N'160',N'3',N'',N'기타',N'',N'',160,1,N'13','2',getdate(),'2',getdate());
...
INSERT INTO SMP_SITE VALUES ( '1', 'OK플라자(기본)', 'OK플라자 고객사 기본 설정입니다.', (select codeid from SMPCODES where CODETYPECD = 'FRONT_CSS_COLOR' and SMPCODES.CODEVAL1 = '기본'), '/assets/images/okplazaLogo.png', 'N', 0, '2', GETDATE(), '2', GETDATE() );
INSERT INTO SMP_SITE VALUES ( '2', '홈앤서비스', '홈앤서비스 기본 설정입니다.', (select codeid from SMPCODES where CODETYPECD = 'FRONT_CSS_COLOR' and SMPCODES.CODEVAL1 = '검정'), '/assets/images/loginLogo-homs.png', 'N', 0, '2', GETDATE(), '2', GETDATE() );
INSERT INTO SMP_SITE VALUES ( '3', 'OKSafety', 'OKSafety 기본 설정입니다.', (select codeid from SMPCODES where CODETYPECD = 'FRONT_CSS_COLOR' and SMPCODES.CODEVAL1 = '주황'), '/assets/images/loginLogo-safety.png', 'N', 0, '2', GETDATE(), '2', GETDATE() );
--SELECT * FROM SMP_SITE;
INSERT INTO SMP_SITE_TEMP VALUES ( '0', '팬타온', '팬타온을 대상으로 합니다.', 0, 0,'N', 0, '2', GETDATE(), '2', GETDATE(), 'Y' );
INSERT INTO SMP_SITE_TEMP VALUES ( '1', 'OK플라자(기본)', 'OK플라자 일반구매사를 대상으로 합니다.', (select codeid from SMPCODES where CODETYPECD = 'FRONT_CSS_COLOR' and SMPCODES.CODEVAL1 = '기본'), '/assets/images/okplazaLogo.png', 'N', 0 , '2', GETDATE(), '2', GETDATE(), 'Y' ); 
INSERT INTO SMP_SITE_TEMP VALUES ( '2', '홈앤서비스', '홈앤서비스 기본 설정입니다.', (select codeid from SMPCODES where CODETYPECD = 'FRONT_CSS_COLOR' and SMPCODES.CODEVAL1 = '검정'), '/assets/images/loginLogo-homs.png', 'N', 0, '2', GETDATE(), '2', GETDATE(), 'Y' );
INSERT INTO SMP_SITE_TEMP VALUES ( '3', 'OKSafety', 'OKSafety 기본 설정입니다.', (select codeid from SMPCODES where CODETYPECD = 'FRONT_CSS_COLOR' and SMPCODES.CODEVAL1 = '주황'), '/assets/images/loginLogo-safety.png', 'N', 0, '2', GETDATE(), '2', GETDATE(), 'Y' );

-- 배너
-- homs_main_banner01.jpg
-- safety_main_banner02.jpg
-- client_main_banner01.jpg
-- pantaon_main_banner01.jpg
SELECT * FROM SMP_SITE_BANNER;
SELECT * FROM ATTACHINFO WHERE attachInfo.attach_seq = '89449';
-- 팬타온 디폴트 배너 bannerid : 0
-- 구매사 디폴트 배너 bannerid : 1, 2, 3
INSERT INTO SMP_SITE_BANNER 		VALUES ( '1', '구매사 기본배너 1', '2', 'SKB 구성원용', 1, 1, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER			VALUES ( '1', '구매사 기본배너 2', '2', '안전화', 2, 2, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER			VALUES ( '1', '구매사 기본배너 3', '2', '', 3, 3, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER_TEMP	VALUES ( '1', '구매사 기본배너 1', '2', 'SKB 구성원용', 1, 1, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER_TEMP	VALUES ( '1', '구매사 기본배너 2', '2', '안전화', 2, 2, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER_TEMP	VALUES ( '1', '구매사 기본배너 3', '2', '', 3, 3, '2', GETDATE() );
-- HOMS 디폴트 배너 bannerid : 4, 5, 6
INSERT INTO SMP_SITE_BANNER 		VALUES ( '2', 'HOMS 기본배너 1', '2', 'DROP광케이블류', 1, 4, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER			VALUES ( '2', 'HOMS 기본배너 2', '2', 'UTP케이블류', 2, 5, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER			VALUES ( '2', 'HOMS 기본배너 3', '2', 'FTTH부대자재', 3, 6, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER_TEMP	VALUES ( '2', 'HOMS 기본배너 1', '2', 'DROP광케이블류', 1, 4, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER_TEMP	VALUES ( '2', 'HOMS 기본배너 2', '2', 'UTP케이블류', 2, 5, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER_TEMP	VALUES ( '2', 'HOMS 기본배너 3', '2', 'FTTH부대자재', 3, 6, '2', GETDATE() );
-- OKSAFETy 디폴트 배너 bannerid : 7, 8, 9
INSERT INTO SMP_SITE_BANNER 		VALUES ( '3', 'SAFETY 기본배너 1', '2', 'SKB 구성원용', 1, 7, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER			VALUES ( '3', 'SAFETY 기본배너 2', '2', '안전화', 2, 8, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER			VALUES ( '3', 'SAFETY 기본배너 3', '2', '', 3, 9, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER_TEMP	VALUES ( '3', 'SAFETY 기본배너 1', '2', 'SKB 구성원용', 1, 7, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER_TEMP	VALUES ( '3', 'SAFETY 기본배너 2', '2', '안전화', 2, 8, '2', GETDATE() );
INSERT INTO SMP_SITE_BANNER_TEMP	VALUES ( '3', 'SAFETY 기본배너 3', '2', '', 3, 9, '2', GETDATE() );

-- 지정자재 마이그레이션 - 신규 코드로 업데이트해서 
INSERT INTO MCGOOD_MATERIAL
SELECT 	A.CODEVAL1 AS MATERIAL
,		A.CODENM3 AS MATERIAL_NM
,		A.CODENM1 AS MATERIAL_DESC 
...
update SMPMENUS set MENUNM = '자재혁신제안' where menucd = 'VEN_PDT_PROPOSAL' and agent_id = '13' and SVCTYPECD = 'VEN' and isuse = '1';
...
update SMPMENUS set isuse = '0' where MENUNM = '스마일지수' and agent_id = '13' and SVCTYPECD = 'ADM';
update SMPMENUS set isuse = '0' where MENUNM = '지정자재 단가 계약서 관리' and agent_id = '13' and SVCTYPECD = 'ADM';
...
update SMPMENUS set MENUNM = '자재혁신제안' where menucd = 'VEN_PDT_PROPOSAL' and agent_id = '13' and SVCTYPECD = 'VEN';
...
-- 고객관리 > 중메뉴
INSERT INTO smpmenus (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select next_id +1 from SMP_SEQUENCE WHERE TABLE_NAME = 'SEQMP_CORESYSTEM'),N'ADM_ORAGN_SITE',N'구매사 사이트관리',(select menuid from SMPMENUS where menucd = 'ADM_ORGAN' and agent_id= '13' and svctypecd= 'ADM'),(select menuid from SMPMENUS where menucd = 'ADM_ORGAN' and agent_id= '13' and svctypecd= 'ADM'),1,215,N'ADM',0,1,N'/menu/organ/organClientSiteManage.sys',N'13');

-- 주문관리 > 주문관리 > 주문일자수정
--select * from SMPMENUS where MENUNM like '%주문일자%';
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'ADM_ORDER_DATE_CHG',N'주문일자수정',12763,12764,2,120,N'ADM',0,1,N'/order/orderRequest/orderDateChg.sys',N'13');
...
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'AMD_PTO_RTN',N'팬타온 교환/반품',(select s.MENUID  from SMPMENUS s where s.MENUNM = '팬타온'),(select s.MENUID  from SMPMENUS s where s.MENUNM = '팬타온'),1,235,N'ADM',0,1,N'/menu/order/returnOrder/pentaonReturnList.sys',N'13');
...
-- 고객센터 - 메뉴얼
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'ADM_BOARD_MENUAL',N'메뉴얼',(select s.MENUID  from SMPMENUS s where s.MENUCD = 'ADM_BOARD' and svctypecd = 'ADM' and agent_id = '13'),(select s.MENUID  from SMPMENUS s where s.MENUCD = 'ADM_BOARD' and svctypecd = 'ADM' and agent_id = '13'),1,890,N'ADM',0,1,N'javascript:fnMenualDown(''ADM'')',N'13');
...
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ORDER_STEP',N'주문진척도',(select menuid from SMPMENUS where menucd = 'N_BUY_ORDER'),(select menuid from SMPMENUS where menucd = 'N_BUY_ORDER'),1,130,N'BUY',0,1,N'/buyOrder/progress',N'13');
...
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_SAFE_RECEIVE',N'안전(지급)실적조회',(select menuid from SMPMENUS where menucd = 'N_BUY_RECEIVE'),(select menuid from SMPMENUS where menucd = 'N_BUY_RECEIVE'),1,240,N'BUY',0,1,N'/buyReceive/safetyReceiverList',N'13');
...
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM',N'운영관리',0,0,0,600,N'BUY',0,1,N'',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM_BORG_BRNCH',N'사업장 관리',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,611,N'BUY',0,1,N'/buyOrgan/organBuyList?srcIsUse=1',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM_BORG_USER',N'사용자관리',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,612,N'BUY',0,1,N'/buyOrgan/organBuyUserList?srcIsUse=1',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM_BORG_HNS',N'HNS조직관리',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,619,N'BUY',0,1,N'/buyOrgan/hnsBorgList?srcIsUse=1',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM_RESULT_SRC',N'실적조회',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,621,N'BUY',0,1,N'/manage/result/search',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM_RESULT_BIL',N'세금계산서',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,622,N'BUY',0,1,N'/manage/result/ebill',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM_RESULT_DEB',N'채무관리',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,623,N'BUY',0,1,N'/manage/result/debt',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM_STK_MGE',N'사업장별 재고',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,631,N'BUY',0,1,N'/manage/stock/stockManage',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM_STK_INQ',N'재고조회',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,632,N'BUY',0,1,N'/manage/stock/stockInquiry',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM_STK_TRAN',N'재고이동승인',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,633,N'BUY',0,1,N'/manage/stock/stockTransfer',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM_STK_SUR',N'재고조사이력',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,634,N'BUY',0,1,N'/manage/stock/stockSurvey',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM_BUD_MGE',N'예산관리',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,641,N'BUY',0,1,N'/manage/budget/budgetManage',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM_BUD_APP',N'예산승인',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,642,N'BUY',0,1,N'/manage/budget/budgetApproval',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM_APP',N'상품승인',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,651,N'BUY',0,1,N'/manage/product/approval',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_ADM_DISPLAY',N'상품진열',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,652,N'BUY',0,1,N'/manage/product/display',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_SAF_MGMT',N'산업안전보건관리비',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,661,N'BUY',0,1,N'/safe/safetyMgmtList',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_SAF_MGMT_MTH',N'산업안전보건관리비 월별 사용내역',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,662,N'BUY',0,1,N'/safe/mgmtResultList',N'13');
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'N_BUY_SAF_SKB_MTH',N'SKB 산업안전보건관리비 월별 사용내역',(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),(select menuid from SMPMENUS where menucd = 'N_BUY_ADM'),1,663,N'BUY',0,1,N'/safe/skbMgmtResultList',N'13');
...
INSERT INTO SMPMENUS (MENUID,MENUCD,MENUNM,TOPMENUID,PARMENUID,MENULEVEL,DISORDER,SVCTYPECD,ISFIXED,ISUSE,FWDPATH,AGENT_ID) VALUES ((select max(s.menuid) + 1 from SMPMENUS s),N'VEN_CS_MENUAL',N'메뉴얼',(select menuid from smpmenus where menucd= 'VEN_CS' and agent_id = '13'),(select menuid from smpmenus where menucd= 'VEN_CS' and agent_id = '13'),1,1560,N'VEN',0,1,N'javascript:fnMenualDown(''VEN'')',N'13');
...
INSERT INTO SMPMENUS_ACTIVITIES	(MENUID, ACTIVITYID, MENUCD, ACTIVITYCD, AGENT_ID ) VALUES ((select menuid from smpmenus where menucd = 'ADM_ORDER_DATE_CHG' and isuse = 1), '1', 'ADM_ORDER_DATE_CHG', 'COMM_READ','13');
INSERT INTO SMPMENUS_ACTIVITIES	(MENUID, ACTIVITYID, MENUCD, ACTIVITYCD, AGENT_ID ) VALUES ((select menuid from smpmenus where menucd = 'ADM_ORDER_DATE_CHG' and isuse = 1), '2', 'ADM_ORDER_DATE_CHG', 'COMM_SAVE','13');
...
INSERT INTO SMPMENUS_ACTIVITIES	(MENUID, ACTIVITYID, MENUCD, ACTIVITYCD, AGENT_ID ) VALUES ((select menuid from smpmenus where menucd = 'ADM_BOARD_MENUAL' and isuse = 1), '1', 'ADM_BOARD_MENUAL', 'COMM_READ','13');
INSERT INTO SMPMENUS_ACTIVITIES	(MENUID, ACTIVITYID, MENUCD, ACTIVITYCD, AGENT_ID ) VALUES ((select menuid from smpmenus where menucd = 'ADM_BOARD_MENUAL' and isuse = 1), '2', 'ADM_BOARD_MENUAL', 'COMM_SAVE','13');
...
-- ADM_ORDER_SAVE
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_ORDER_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_ORDER_DATE_CHG'),2,N'ADM_ORDER_DATE_CHG',N'COMM_SAVE',N'ADM_ORDER_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_ORDER_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_ORDER_DATE_CHG'),1,N'ADM_ORDER_DATE_CHG',N'COMM_READ',N'ADM_ORDER_SAVE',N'13');

-- ADM_ORDER_READ
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_ORDER_READ' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_ORDER_DATE_CHG'),1,N'ADM_ORDER_DATE_CHG',N'COMM_READ',N'ADM_ORDER_READ',N'13');
...
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_MGT'),2,N'ADM_MATERIAL_MGT',N'COMM_SAVE',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_MGT'),1,N'ADM_MATERIAL_MGT',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_BID'),2,N'ADM_MATERIAL_BID',N'COMM_SAVE',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_BID'),1,N'ADM_MATERIAL_BID',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_SALE'),2,N'ADM_MATERIAL_SALE',N'COMM_SAVE',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_SALE'),1,N'ADM_MATERIAL_SALE',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_SETTING'),2,N'ADM_MATERIAL_SETTING',N'COMM_SAVE',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_SETTING'),1,N'ADM_MATERIAL_SETTING',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_VEN'),2,N'ADM_MATERIAL_VEN',N'COMM_SAVE',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_VEN'),1,N'ADM_MATERIAL_VEN',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MCGOOD_BID'),2,N'ADM_MCGOOD_BID',N'COMM_SAVE',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MCGOOD_BID'),1,N'ADM_MCGOOD_BID',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_COMP_BID'),2,N'ADM_COMP_BID',N'COMM_SAVE',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_COMP_BID'),1,N'ADM_COMP_BID',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_PER_SUM'),2,N'ADM_MATERIAL_PER_SUM',N'COMM_SAVE',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_PER_SUM'),1,N'ADM_MATERIAL_PER_SUM',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_COMP_PER_SUM'),2,N'ADM_COMP_PER_SUM',N'COMM_SAVE',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_SAVE' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_COMP_PER_SUM'),1,N'ADM_COMP_PER_SUM',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
...
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_READ' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_MGT'),1,N'ADM_MATERIAL_MGT',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_READ' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_BID'),1,N'ADM_MATERIAL_BID',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_READ' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_SALE'),1,N'ADM_MATERIAL_SALE',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_READ' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_SETTING'),1,N'ADM_MATERIAL_SETTING',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_READ' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_VEN'),1,N'ADM_MATERIAL_VEN',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_READ' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MCGOOD_BID'),1,N'ADM_MCGOOD_BID',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_READ' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_COMP_BID'),1,N'ADM_COMP_BID',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_READ' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_MATERIAL_PER_SUM'),1,N'ADM_MATERIAL_PER_SUM',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_PRD_READ' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_COMP_PER_SUM'),1,N'ADM_COMP_PER_SUM',N'COMM_READ',N'ADM_PRD_SAVE',N'13');
...
-- 기타영역 ADM_OTHER
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_OTHER' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_BOARD_MENUAL'),2,N'ADM_BOARD_MENUAL',N'COMM_SAVE',N'ADM_OTHER',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'ADM_OTHER' and agent_id = '13'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD =  'ADM_BOARD_MENUAL'),1,N'ADM_BOARD_MENUAL',N'COMM_READ',N'ADM_OTHER',N'13');
...
--select scopeid from smpscopes where scopecd = 'N_BUY_NHS_GRP';
--select * from SMPSCOPES_ACTIVITIES where scopeid = (select scopeid from smpscopes where scopecd = 'N_BUY_NHS_GRP');
--delete SMPSCOPES_ACTIVITIES where scopeid = (select scopeid from smpscopes where scopecd = 'N_BUY_NHS_GRP');
...
-- 공급사 추가 - 견적/메뉴얼
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'VEN_MNG2'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD = 'VEN_CS_MENUAL'),2,N'VEN_CS_MENUAL',N'COMM_SAVE',N'VEN_MNG2',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'VEN_MNG2'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD = 'VEN_CS_MENUAL'),1,N'VEN_CS_MENUAL',N'COMM_READ',N'VEN_MNG2',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'VEN_MNG2'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD = 'VEN_PDT_QUO'),2,N'VEN_PDT_QUO',N'COMM_SAVE',N'VEN_MNG2',N'13');
INSERT INTO SMPSCOPES_ACTIVITIES (SCOPEID,MENUID,ACTIVITYID,MENUCD,ACTIVITYCD,SCOPECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'VEN_MNG2'),(SELECT MENUID FROM SMPMENUS WITH(NOLOCK) WHERE MENUCD = 'VEN_PDT_QUO'),1,N'VEN_PDT_QUO',N'COMM_READ',N'VEN_MNG2',N'13');
...
-- 권한 수정
UPDATE smproles set isuse = 0 where svctypecd = 'BUY' and isuse = 1 and agent_id = '13' and ROLECD not in ('BUY_CLT', 'BUY_GEN', 'BUY_HNS_DIR', 'BUY_HNS_GEN', 'BUY_HNS_MST', 'BUY_HNS_MST2', 'SAF_USER', 'SAF_CON', 'SAF_SKB_GEN', 'SAF_SKB', 'BUY_PENTAON');
...
----------- 지점장 권한 일반권한으로 변경 및 추가
delete SMPROLES_SCOPES where ROLECD = 'BUY_HNS_DIR' and agent_id = '13' ;
INSERT INTO SMPROLES_SCOPES (SCOPEID,ROLEID,SCOPECD,ROLECD,AGENT_ID) VALUES ((select scopeid from smpscopes where scopecd = 'N_BUY_HNS_GEN'),(select roleid from smproles where rolecd = 'BUY_HNS_DIR' and agent_id = '13'),(select scopeid from smpscopes where scopecd = 'N_BUY_HNS_GEN'),N'BUY_HNS_DIR',N'13');
...
-- 공통자재 비품/관리 안전(OKplaza) 카테고리의 물류 상품(단품) 팬타온 상품으로 마이그레이션 
...
WHERE A.CATE_ID IN (
	...
	WHERE M.CATE_CD LIKE (
		SELECT CATE_CD + '%'
		FROM MCCATEGORYMASTER 
		WHERE MAJO_CODE_NAME = '안전(OKplaza)'
		AND AGENT_ID = '13'
		AND CATE_LEVEL = '1'
	) AND AGENT_ID = '13'
)
...
-- 상품 진열
MERGE MCGOODDISPLAY A
USING (
   SELECT   A.*
   ,      (SELECT   MAX(GOOD_DISPLAY_ID)
         FROM   mcgooddisplay WITH(NOLOCK)) + ROW_NUMBER() OVER (ORDER BY (SELECT NULL))    AS NEW_ID
   FROM (
      	SELECT	
		A.GOOD_IDEN_NUMB,
		MAX(B.VENDORID) AS VENDORID
   ...
   GROUP BY A.GOOD_IDEN_NUMB, A.VENDORID
) B
ON   A.GOOD_IDEN_NUMB = B.GOOD_IDEN_NUMB
AND   A.VENDORID = B.VENDORID
AND	DISPLAY_TYPE = '20'
AND	DISPLAY_TYPE_CD = '1'
WHEN NOT MATCHED
THEN
   INSERT (
		GOOD_DISPLAY_ID,
...
update SMP_SEQUENCE 
set next_id = (select max(good_display_id) + 2 from MCGOODDISPLAY)
WHERE table_name = 'SEQMCGOODDISPLAY';


--SELECT * FROM mcgooddisplay m WHERE GOOD_IDEN_NUMB = '10000063234'

-- 팬타온 전시 상품 랜덤 입력
SELECT * FROM BAT_PTO_POPULAR_GOOD bppg ;
select * from BAT_PTO_BEST_GOOD;
...
AND A.STOCK_YN = 'Y'
AND B.ISUSE = 1
AND ISNULL(B.ORIGINAL_IMG_PATH, '') != ''
GROUP BY A.GOOD_IDEN_NUMB

-- 팬타온 인기상품 임시 마이그레이션(랜덤)
INSERT INTO BAT_PTO_POPULAR_GOOD (
	GOOD_IDEN_NUMB,
	VENDORID,
	RANK,
	REGI_DATE_TIME
...
SELECT TOP 10
	A.GOOD_IDEN_NUMB,
	A.VENDORID,
	ROW_NUMBER() OVER (ORDER BY NEWID()) AS RANK,
	GETDATE() AS REGI_DATE_TIME
FROM (
	SELECT	
		A.GOOD_IDEN_NUMB,
		MAX(B.VENDORID) AS VENDORID
...
ORDER BY RANK, NEWID() DESC;
--------------------------------------------
INSERT INTO BAT_PTO_BEST_GOOD (
	GOOD_IDEN_NUMB,
	VENDORID,
	CUST_CATE_CD,
	RANK,
...
-----------------------------------------------------------------------------------------------
-- 주문상품/ 주문 인수테이블 품종관련 마이그레이션
UPDATE B
SET B.MATERIAL = C.MATERIAL
,	B.MATERIAL_DETL_CD = C.MATERIAL_SUB
FROM MRORDM A 
INNER JOIN MRORDT B 
	ON A.ORDE_IDEN_NUMB = B.ORDE_IDEN_NUMB 
INNER JOIN MCGOOD C
	ON B.GOOD_IDEN_NUMB = C.GOOD_IDEN_NUMB 
	AND C.GOOD_TYPE = '20'
WHERE A.REGI_DATE_TIME > '2024-01-01';
;
...
--SELECT * FROM BAT_PTO_POPULAR_GOOD
	/*
	SELECT * FROM BAT_BEST_GOOD;
	SELECT * FROM MCCUST_CATE_NEW mcn WHERE mcn.CUST_CATE_MAST_CD = 'PTO';*/
	-- PTO01	PTO	PTO	공통자재
	-- PTO06	PTO	PTO	비품/관리
	-- PTO13	PTO	PTO	안전(OKplaza)
---------------------------------------------------------------------------------------------
-- 검색엔진
-- 자주 변경이 될거같아 파일 분리함
...
/*UPDATE SMPBRANCHS SET BRANCHCD = 'GEN'+BRANCHID WHERE BRANCHCD = 'GEN0000506';
UPDATE SMPBORGS SET BORGCD = 'GEN'+BORGID WHERE BORGCD = 'GEN0000506';*/
--------------------------------------------------------------------------------------
-- 전자입찰 DDL
...
INSERT INTO Bidding.dbo.T_TEMPLATE_MNG
(TEMPLATE_CD, SEND_TYPE, SEND_SVC, TITLE, CONTENTS, DESCRIPTION, INSERT_USER_ID, INSERT_DATE, UPDATE_USER_ID, UPDATE_DATE)
VALUES(N'E-Bid001', N'KKO', N'BID', N'신규업체 승인요청', N'[팬택 E-Bid] 협력사(#{custName})에서 회원가입 요청이왔습니다. 
업체승인 페이지에서 업체를 확인 후 3일 내 처리해 주십시오', N'계열사 관리자권한을 가지 사용자', NULL, NULL, NULL, NULL);
INSERT INTO Bidding.dbo.T_TEMPLATE_MNG
(TEMPLATE_CD, SEND_TYPE, SEND_SVC, TITLE, CONTENTS, DESCRIPTION, INSERT_USER_ID, INSERT_DATE, UPDATE_USER_ID, UPDATE_DATE)
VALUES(N'E-Bid002', N'KKO', N'BID', N'회원가입 승인시', N'[팬택 E-Bid] 요청하신 팬택 E-Bid 전자입찰 시스템 회원가입이 승인되었습니다.', N'승인된 협력사', NULL, NULL, NULL, NULL);
INSERT INTO Bidding.dbo.T_TEMPLATE_MNG
(TEMPLATE_CD, SEND_TYPE, SEND_SVC, TITLE, CONTENTS, DESCRIPTION, INSERT_USER_ID, INSERT_DATE, UPDATE_USER_ID, UPDATE_DATE)
VALUES(N'E-Bid003', N'KKO', N'BID', N'입찰계획 등록 시', N'[팬택 E-Bid] 입찰계획을 등록하였습니다. 입찰명은 [#{biName}] 입니다.', N'입찰공고자', NULL, NULL, NULL, NULL);
INSERT INTO Bidding.dbo.T_TEMPLATE_MNG
(TEMPLATE_CD, SEND_TYPE, SEND_SVC, TITLE, CONTENTS, DESCRIPTION, INSERT_USER_ID, INSERT_DATE, UPDATE_USER_ID, UPDATE_DATE)
VALUES(N'E-Bid004', N'KKO', N'BID', N'입찰계획 삭제 시', N'[팬택 E-Bid] 입찰계획을 삭제하였습니다. 입찰명은 [#{biName}] 입니다.', N'입찰공고자', NULL, NULL, NULL, NULL);
INSERT INTO Bidding.dbo.T_TEMPLATE_MNG
(TEMPLATE_CD, SEND_TYPE, SEND_SVC, TITLE, CONTENTS, DESCRIPTION, INSERT_USER_ID, INSERT_DATE, UPDATE_USER_ID, UPDATE_DATE)
VALUES(N'E-Bid005', N'KKO', N'BID', N'유찰 시', N'[팬택 E-Bid] 공고된 입찰[#{biName}]이 유찰되었습니다.', N'투찰한 업체', NULL, NULL, NULL, NULL);
INSERT INTO Bidding.dbo.T_TEMPLATE_MNG
(TEMPLATE_CD, SEND_TYPE, SEND_SVC, TITLE, CONTENTS, DESCRIPTION, INSERT_USER_ID, INSERT_DATE, UPDATE_USER_ID, UPDATE_DATE)
VALUES(N'E-Bid006', N'KKO', N'BID', N'재입찰 발송', N'[팬택 E-Bid] 팬택 E-Bid 전자입찰에서 재입찰을 공고하였습니다. 확인바랍니다.', N'재입찰 시 선택된 협력사', NULL, NULL, NULL, NULL);
INSERT INTO Bidding.dbo.T_TEMPLATE_MNG
(TEMPLATE_CD, SEND_TYPE, SEND_SVC, TITLE, CONTENTS, DESCRIPTION, INSERT_USER_ID, INSERT_DATE, UPDATE_USER_ID, UPDATE_DATE)
VALUES(N'E-Bid007', N'KKO', N'BID', N'낙찰 시', N'[팬택 E-Bid] 참여하신 입찰(#{biName})에 낙찰되었습니다. 확인바랍니다.', N'낙찰된 업체', NULL, NULL, NULL, NULL);
INSERT INTO Bidding.dbo.T_TEMPLATE_MNG
(TEMPLATE_CD, SEND_TYPE, SEND_SVC, TITLE, CONTENTS, DESCRIPTION, INSERT_USER_ID, INSERT_DATE, UPDATE_USER_ID, UPDATE_DATE)
VALUES(N'E-Bid008', N'KKO', N'BID', N'지명경쟁입찰일때, 입찰 공고시', N'[팬택 E-Bid] 참여하실 입찰(#{biName})이 공고되었습니다. 확인바랍니다.', N'지명경쟁입찰: 선택된 입찰 참가업체', NULL, NULL, NULL, NULL);
INSERT INTO Bidding.dbo.T_TEMPLATE_MNG
(TEMPLATE_CD, SEND_TYPE, SEND_SVC, TITLE, CONTENTS, DESCRIPTION, INSERT_USER_ID, INSERT_DATE, UPDATE_USER_ID, UPDATE_DATE)
VALUES(N'E-Bid009', N'KKO', N'BID', N'입찰투찰 독촉', N'[팬택 E-Bid] 입찰(#{biName}) 마감시간이 다가오고 있습니다. 확인바랍니다.', N'지명된 협력사 중 투찰하지 않은 협력사 사용자', NULL, NULL, NULL, NULL);
INSERT INTO Bidding.dbo.T_TEMPLATE_MNG
(TEMPLATE_CD, SEND_TYPE, SEND_SVC, TITLE, CONTENTS, DESCRIPTION, INSERT_USER_ID, INSERT_DATE, UPDATE_USER_ID, UPDATE_DATE)
VALUES(N'E-Bid010', N'KKO', N'BID', N'입찰마감 시', N'[팬택 E-Bid] 공고된 입찰[#{biName}]이 마감되었습니다. 입찰을 개찰 후 낙찰/유찰 처리해 주십시오', N'개찰자', NULL, NULL, NULL, NULL);
INSERT INTO Bidding.dbo.T_TEMPLATE_MNG
(TEMPLATE_CD, SEND_TYPE, SEND_SVC, TITLE, CONTENTS, DESCRIPTION, INSERT_USER_ID, INSERT_DATE, UPDATE_USER_ID, UPDATE_DATE)
VALUES(N'E-Bid011', N'KKO', N'BID', N'회원가입 반려시', N'[팬택 E-Bid] 요청하신 팬택 E-Bid 전자입찰 시스템 회원가입이 반려되었습니다.', N'반려된 협력사', NULL, NULL, NULL, NULL);
INSERT INTO Bidding.dbo.T_TEMPLATE_MNG
(TEMPLATE_CD, SEND_TYPE, SEND_SVC, TITLE, CONTENTS, DESCRIPTION, INSERT_USER_ID, INSERT_DATE, UPDATE_USER_ID, UPDATE_DATE)
VALUES(N'E-Bid101', N'SMS', N'BID', N'랜딩페이지 > 아이디 찾기', N'[팬택 E-Bid] 찾고자 하는 아이디는 #{loginId} 입니다.', N'아이디 찾는 사용자', NULL, NULL, NULL, NULL);
INSERT INTO Bidding.dbo.T_TEMPLATE_MNG
(TEMPLATE_CD, SEND_TYPE, SEND_SVC, TITLE, CONTENTS, DESCRIPTION, INSERT_USER_ID, INSERT_DATE, UPDATE_USER_ID, UPDATE_DATE)
VALUES(N'E-Bid102', N'SMS', N'BID', N'랜딩페이지 > 비밀번호 찾기', N'[팬택 E-Bid] 초기화 된 비밀번호는 #{loginPw} 입니다.', N'비밀번호 찾는 사용자', NULL, NULL, NULL, NULL);
